...
namespace TwitchGameAutomate
{
    ...
    class Program
    {
        ...
        static void updateTwitch(string game, string sid, string mid)
        {
            ...
            System.Diagnostics.Process.Start("https://api.twitch.tv/kraken/oauth2/authorize?response_type=token&client_id=9xcf5l6r7kipl9d0mkmnjltoo8y3wv9&redirect_uri=http://localhost&scope=user_read+channel_editor+channel_read");
